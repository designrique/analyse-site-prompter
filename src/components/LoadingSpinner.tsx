...
export const LoadingSpinner: React.FC = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center p-12 bg-brand-secondary/50 rounded-lg">
        ...
        <p className="mt-4 text-lg text-slate-300">Analisando o design system...</p>
